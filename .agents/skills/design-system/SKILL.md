...
**Generate tokens:**
```bash
node e:/Pruba antigravity/.agents/skills/design-system/scripts/generate-tokens.cjs --config tokens.json -o tokens.css
```

**Validate usage:**
```bash
node e:/Pruba antigravity/.agents/skills/design-system/scripts/validate-tokens.cjs --dir src/
```
...
python e:/Pruba antigravity/.agents/skills/design-system/scripts/search-slides.py "investor pitch"

# Domain-specific search
python e:/Pruba antigravity/.agents/skills/design-system/scripts/search-slides.py "problem agitation" -d copy
python e:/Pruba antigravity/.agents/skills/design-system/scripts/search-slides.py "revenue growth" -d chart

# Contextual search (Premium System)
python e:/Pruba antigravity/.agents/skills/design-system/scripts/search-slides.py "problem slide" --context --position 2 --total 9
python e:/Pruba antigravity/.agents/skills/design-system/scripts/search-slides.py "cta" --context --position 9 --prev-emotion frustration
```
